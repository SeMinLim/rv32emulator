...
* r : Reads the value of the registers. Both register number and alias formats can be used, without space after 'r'. e.g., `rx0`, `rra`. A simple `r` with no trailing register name will print all registers
